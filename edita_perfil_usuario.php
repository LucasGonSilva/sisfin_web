...
if (isset($_GET['id'])) {
    $query = $db->query("SELECT * FROM tb_perfil WHERE id = {$_GET['id']}");
...
<?php if (($_SERVER['REQUEST_METHOD'] == 'POST')) { ?>
    ...
    try {
        ...
        echo "<br/><div class='alert alert-success' role='alert'><b>Registro salvo com sucesso!</b><br /><script>window.location='?pg=perfil_usuarios';</script></div>";
    } catch (Exception $e) {
