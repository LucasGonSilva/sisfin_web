    ...
    $(document).ready(function () {
        $('.excluir').on('click', function (e) {
            ...
            if (confirm("Deseja excluir?")) {
                window.location.replace("?pg=forma_pagamento&acao=excluir&id=" + $(this).attr('href'));
            }
        });
...
<?php
$sql = "SELECT * FROM sisfin_web.tb_forma_pagamento ORDER BY descricao";
...
<div class="row">
    <div class="col-md-6 align-middle">
        <h4 class="align-middle">Formas de Pagamento</h4>
    </div>
    <div class="col-md-6">
        <a href="?pg=forma_pagamento_crud" class="btn btn-primary btn-sm float-right" role="button" aria-disabled="true">Adicionar Nova</a>
    </div>
</div>
<div class="row">
