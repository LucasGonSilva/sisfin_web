...
if (isset($_GET['id'])) {
    $query = $db->query("SELECT * FROM tb_categoria_financeira WHERE id = {$_GET['id']}");
...
<div class="row">
    <div class="col-md-6 align-middle">
        <h1 class="align-middle">Editar Perfil Usuário</h1>
    </div>
    <div class="col-md-6">
        <a href="?pg=categoria_financeira" class="btn btn-primary btn-sm float-right" role="button" aria-disabled="true">Lista de Categorias</a>
    </div>
</div>
...
<?php if (($_SERVER['REQUEST_METHOD'] == 'POST')) { ?>
    ...
    try {
        ...
        $sql = "UPDATE tb_categoria_financeira SET
