...
<div class="row">
    <div class="col-md-6 align-middle">
        <h1 class="align-middle">Lista de Usuários</h1>
    </div>
    <div class="col-md-6">
        <a href="?pg=novo_usuario" class="btn btn-primary btn-sm float-right" role="button" aria-disabled="true">Adicionar Novo</a>
    </div>
</div>
<div class="row">
    <table class="table">
