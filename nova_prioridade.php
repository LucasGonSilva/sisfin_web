...
<script>
    function verificaDescricao() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: 'ajax/ajax_tarefa.php?acao=verificaDescricao',
            data: {
                descricao: descricao
            },
...
<div class="row">
    <div class="col-md-6 align-middle">
        <h1 class="align-middle">Nova Prioridade</h1>
    </div>
    <div class="col-md-6">
        <a href="?pg=prioridades" class="btn btn-primary btn-sm float-right" role="button" aria-disabled="true">Lista de Prioridade</a>
    </div>
</div>
    ...
    <div class="row">
        <div class="col col-lg-6">
            <div class="form-group">
                ...
                <input class="form-control input-input-lg" type="text" name="txtDescricao" required="required" id="txtDescricao" onkeypress="verificaDescricao()">
...
<?php if (($_SERVER['REQUEST_METHOD'] == 'POST')) { ?>
    ...
    try {
        ...
        if ($descricao == "") {
            echo '<p class="alert alert-danger">Campo descrição obrigatorio!</p>';
        } else {
            $sql = "INSERT INTO tb_prioridade_tarefa(
                                    descricao,
                                    created
                                )
                                  VALUES ('{$descricao}',
            ...
            echo "<br/><div class='alert alert-success' role='alert'><b>Registro salvo com sucesso!</b><br /><script>window.location='?pg=prioridades';</script></div>";
        }
    } catch (Exception $e) {
